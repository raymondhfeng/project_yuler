...
from .views import line_chart_num_plrs_pred_tobit_json
...
urlpatterns = [
    ...
    path('num_plrs_pred_tobitJSON', line_chart_num_plrs_pred_tobit_json, name='line_chart_num_plrs_pred_tobit_json'),
